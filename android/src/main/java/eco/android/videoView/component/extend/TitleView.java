...
public class TitleView extends FrameLayout implements IControlComponent {
    ...
    {
        setVisibility(GONE);
        LayoutInflater.from(getContext()).inflate(com.dueeeke.videocontroller.R.layout.dkplayer_layout_title_view, this, true);
        mTitleContainer = findViewById(com.dueeeke.videocontroller.R.id.title_container);
        mBack = findViewById(com.dueeeke.videocontroller.R.id.back);
        ...
        mTitle = findViewById(com.dueeeke.videocontroller.R.id.title);
        mSysTime = findViewById(com.dueeeke.videocontroller.R.id.sys_time);
        //电量
        mBatteryLevel = findViewById(com.dueeeke.videocontroller.R.id.iv_battery);
